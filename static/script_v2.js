...
async function getNewsForPortfolio() {
    try {
        ...
        const prompt = `Please find and analyse 5-10 recent True Existing news items about these financial assets: ${symbols}. 
...
async function sendChatMessage() {
    ...
    try {
        ...
        // Construct the prompt with portfolio context
        const prompt = `You are a financial portfolio assistant analyzing this portfolio:
